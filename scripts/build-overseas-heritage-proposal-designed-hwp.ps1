...
$inputDir = Join-Path $PSScriptRoot '..\output\overseas_heritage_hwp_pages'
$inputDir = [System.IO.Path]::GetFullPath($inputDir)
$outputPath = Join-Path $PSScriptRoot '..\output\proposal_2026_overseas_korean_heritage_designed.hwp'
