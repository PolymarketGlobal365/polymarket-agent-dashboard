...
$generatorPath = Join-Path $PSScriptRoot 'generate-kat-score-boost-rtf.mjs'
$generatorPath = [System.IO.Path]::GetFullPath($generatorPath)
$inputPath = Join-Path $PSScriptRoot '..\output\kat_score_boost_edits_editable.rtf'
$inputPath = [System.IO.Path]::GetFullPath($inputPath)
$outputPath = Join-Path $PSScriptRoot '..\output\kat_score_boost_edits_editable.hwp'
