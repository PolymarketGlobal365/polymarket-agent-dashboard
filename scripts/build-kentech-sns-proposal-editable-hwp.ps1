...
$inputPath = Join-Path $PSScriptRoot '..\output\proposal_2026_kentech_sns_editable.html'
$inputPath = [System.IO.Path]::GetFullPath($inputPath)
$outputPath = Join-Path $PSScriptRoot '..\output\proposal_2026_kentech_sns_editable.hwp'
