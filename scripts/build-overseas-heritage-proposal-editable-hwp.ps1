...
$inputPath = Join-Path $PSScriptRoot '..\output\proposal_2026_overseas_korean_heritage_designed.html'
$inputPath = [System.IO.Path]::GetFullPath($inputPath)
$outputPath = Join-Path $PSScriptRoot '..\output\proposal_2026_overseas_korean_heritage_editable.hwp'
