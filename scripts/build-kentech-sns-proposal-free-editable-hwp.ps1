...
$inputPath = Join-Path $PSScriptRoot '..\output\proposal_2026_kentech_sns_free_editable.html'
$inputPath = [System.IO.Path]::GetFullPath($inputPath)
$outputPath = Join-Path $PSScriptRoot '..\output\proposal_2026_kentech_sns_free_editable.hwp'
