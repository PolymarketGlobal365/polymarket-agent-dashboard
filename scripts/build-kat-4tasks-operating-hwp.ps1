...
$generatorPath = Join-Path $PSScriptRoot 'generate-kat-4tasks-operating-rtf.mjs'
$generatorPath = [System.IO.Path]::GetFullPath($generatorPath)
$inputPath = Join-Path $PSScriptRoot '..\output\kat_4tasks_operating_plan_editable.rtf'
$inputPath = [System.IO.Path]::GetFullPath($inputPath)
$outputPath = Join-Path $PSScriptRoot '..\output\kat_4tasks_operating_plan_editable.hwp'
