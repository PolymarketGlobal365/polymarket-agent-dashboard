...
$generatorPath = Join-Path $PSScriptRoot 'generate-kat-proposal-designed-editable-html.mjs'
$generatorPath = [System.IO.Path]::GetFullPath($generatorPath)
$inputPath = Join-Path $PSScriptRoot '..\output\proposal_2026_korean_artist_today_designed_editable.html'
$inputPath = [System.IO.Path]::GetFullPath($inputPath)
$outputPath = Join-Path $PSScriptRoot '..\output\proposal_2026_korean_artist_today_designed_editable.hwp'
